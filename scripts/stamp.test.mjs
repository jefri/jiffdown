...
import { isoWeek, nextVersion } from "./stamp.mjs";
...
describe("stamp — CalVer (YYYY.ISO_WEEK.MICRO)", () => {
  ...
  it("starts MICRO at 0 from a non-CalVer (legacy semver) current version", () => {
    // jiffdown's first stamp cuts from 1.0.0 into the CalVer line.
    assert.equal(nextVersion("1.0.0", new Date(2026, 5, 10)), "2026.24.0");
